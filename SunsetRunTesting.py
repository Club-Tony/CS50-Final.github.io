...
import sys
import cProfile
# cProfile to see how game is running/what's taking a lot of time/processing. Put everything in def main() function
def main(): 
    ...
    while run:
        ...
        # track fps
        fps_check = clock.get_fps()
        print(f"FPS: {fps_check:.2f}")
